/**
 * @fileoverview Employee Management Type Definitions (Frontend)
 *
 * This module defines all TypeScript interfaces and types for the employee management
 * system on the frontend. Mirrors backend types but adapted for frontend usage with
 ...
 *
 * Note: Date fields are strings in ISO format (YYYY-MM-DD or ISO 8601) since
 * they are received from and sent to the REST API as JSON.
 *
...
/**
 * @interface Employee
 * @description Complete employee record from the backend API
 *
 ...
 *
 * Used when calling POST /api/v1/employees endpoint. All required fields must be provided.
 ...
 *
 * Used when calling PUT /api/v1/employees/:id endpoint. All fields are optional - only
 ...
 * @property {string} [phone] - Updated phone number (max 20 characters)
 * @property {number} [role_id] - Updated role ID (must be valid role ID)
 * @property {string} [assigned_terminal_id] - Updated terminal assignment (UUID)
 * @property {string} [termination_date] - Set termination date in ISO format YYYY-MM-DD (used when terminating employee)
 ...
 *
 * Used when calling GET /api/v1/employees endpoint to filter the employee list.
 ...
 * @description Combined filter and pagination options for employee list queries
 *
 * Extends EmployeeFilters with pagination options. Used when calling GET /api/v1/employees.
 *
 * @extends EmployeeFilters
 ...
 *
 * Used when calling POST /api/v1/roles endpoint. After creating a role, use the
 ...
 *
 * Used when calling PUT /api/v1/roles/:id endpoint. All fields are optional.
 ...
 * @property {string} [description] - Updated description (max 255 characters)
 ...
 *
 * Returned by GET /api/v1/roles/:id endpoint to provide a role with its complete
 ...
 *
 * Used when calling POST /api/v1/roles/:roleId/permissions endpoint. Creates a many-to-many
 ...
 *
 * @example
 * const assignment: AssignPermissionInput = {
 *   permission_id: 5
 * };
 */
